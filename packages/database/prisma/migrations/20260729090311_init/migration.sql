...
-- CreateIndex
CREATE INDEX "AgentDocument_documentId_idx" ON "AgentDocument"("documentId");

-- CreateIndex
CREATE UNIQUE INDEX "AgentDocument_agentId_documentId_key" ON "AgentDocument"("agentId", "documentId");
...
-- AddForeignKey
ALTER TABLE "AgentDocument" ADD CONSTRAINT "AgentDocument_documentId_fkey" FOREIGN KEY ("documentId") REFERENCES "Document"("id") ON DELETE CASCADE ON UPDATE CASCADE;
